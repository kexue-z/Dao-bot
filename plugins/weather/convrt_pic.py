...
font_dir = './data/msyh.ttc'
s20 = ImageFont.truetype(font_dir, 20)
s30 = ImageFont.truetype(font_dir, 30)
s40 = ImageFont.truetype(font_dir, 40)
s50 = ImageFont.truetype(font_dir, 50)
s100 = ImageFont.truetype(font_dir, 100)
icon_dir = "./data/icon/"
...
def draw(data) -> Image:
    ...
    d = ImageDraw.Draw(im)
    # 背景框1
    d.rounded_rectangle([(20, 20), (20+background_width,
                        20+background_hight)], radius=40, fill='#DBDBDB')
    d.rounded_rectangle(
        [(60, 306), (60+mid_box_width, 306+mid_box_height)], radius=20, fill='#CCE1EB')
    d.rounded_rectangle(
        [(640, 306), (640+mid_box_width, 306+mid_box_height)], radius=20, fill='#4C4C4C')
    d.rounded_rectangle([(60, 500), (60+bottom_box_width,
                        500+bottom_box_height)], radius=20, fill='#AAAAAA')
    # 背景框2
    d.rounded_rectangle(
        [(20, 740), (20+background_width, 740+606)], radius=40, fill='#DBDBDB')
    d.rounded_rectangle(
        [(60, 932), (60+mid_box_width, 932+mid_box_height)], radius=20, fill='#CCE1EB')
    d.rounded_rectangle(
        [(640, 932), (640+mid_box_width, 932+mid_box_height)], radius=20, fill='#4C4C4C')
    d.rounded_rectangle([(60, 1126), (60+bottom_box_width,
                        1126+bottom_box_height)], radius=20, fill='#AAAAAA')
    # 背景框3
    d.rounded_rectangle(
        [(20, 1366), (20+background_width, 1366+606)], radius=40, fill='#DBDBDB')
    d.rounded_rectangle(
        [(60, 1558), (60+mid_box_width, 1558+mid_box_height)], radius=20, fill='#CCE1EB')
    d.rounded_rectangle([(640, 1558), (640+mid_box_width,
                        1558+mid_box_height)], radius=20, fill='#4C4C4C')
    d.rounded_rectangle([(60, 1752), (60+bottom_box_width,
                        1752+bottom_box_height)], radius=20, fill='#AAAAAA')
    ...
    d.text((800.5, 530), data['day1']
           ['windScaleDay']+'级', fill='black', font=s40)
    ...
    # 明天
    d.text((377, 784), data['day2']['tempMax']+'-' +
           data['day2']['tempMin']+'°C', fill='black', font=s100)
    ...
    # 后天
    d.text((377, 1410), data['day3']['tempMax']+'-' +
           data['day3']['tempMin']+'°C', fill='black', font=s100)
