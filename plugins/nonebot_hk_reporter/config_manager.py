...
help_match = on_command("help", priority=5)
...
add_sub_matcher = on_command(
    "添加订阅", permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER, priority=5
)
...
query_sub_macher = on_command("查询订阅", priority=5)
...
del_sub_macher = on_command(
    "删除订阅", permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER, priority=5
)
